...
export type activity_logsWhereInput = {
  ...
  log_id?: Prisma.UuidFilter<"activity_logs"> | string
  user_id?: Prisma.UuidNullableFilter<"activity_logs"> | string | null
  ...
  metadata?: Prisma.JsonNullableFilter<"activity_logs">
...
export type activity_logsScalarWhereWithAggregatesInput = {
  ...
  log_id?: Prisma.UuidWithAggregatesFilter<"activity_logs"> | string
  user_id?: Prisma.UuidNullableWithAggregatesFilter<"activity_logs"> | string | null
  ...
  metadata?: Prisma.JsonNullableWithAggregatesFilter<"activity_logs">
...
export type activity_logsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"log_id" | "user_id" | "action" | "entity_type" | "entity_id" | "description" | "ip_address" | "user_agent" | "metadata" | "created_at", ExtArgs["result"]["activity_logs"]>
...
export interface activity_logsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const activity_logsWithLog_idOnly = await prisma.activity_logs.findMany({ select: { log_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Activity_logs and only return the `log_id`
   * const activity_logsWithLog_idOnly = await prisma.activity_logs.createManyAndReturn({
   *   select: { log_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Activity_logs and only return the `log_id`
   * const activity_logsWithLog_idOnly = await prisma.activity_logs.updateManyAndReturn({
   *   select: { log_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface activity_logsFieldRefs {
  readonly log_id: Prisma.FieldRef<"activity_logs", 'String'>
  ...
  readonly metadata: Prisma.FieldRef<"activity_logs", 'Json'>
